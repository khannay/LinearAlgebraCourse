...
\newcommand{\officeHours}{Monday: 4-5 pm, Tuesday 3-4 pm, Thurs:3-5pm, Friday 10-11am}
...
\item  Linear transformations and change of basis (connected to the Singular Value Decomposition - orthonormal bases that diagonalize A)
 \item Linear algebra in engineering and applied mathematics (graphs and networks, Markov matrices, Fourier matrix, Fast Fourier Transform, linear programming)
\end{enumerate}
